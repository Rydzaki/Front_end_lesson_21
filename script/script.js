...
addProductNode.addEventListener('submit', event => {
    ...
    const price = +event.target.price.value; // + для преобразования в число
    ...
    //const product = {title, price, count} // если ключь значения совпадают, можно писать только название
